...
def load():
    ...
    I = st.number_input('Inserte nivel de saturación de oxígeno:  ', 1.0, 100.0, step=0.1) < 89
    J = st.number_input('Inserte su temperatura corporal: ', 30.0, 45.0, step=0.1) > 37.5
